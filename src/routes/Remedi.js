        ...
        <div className="RemediContainer">
          ...
          <section className="RemediMiddle">
            ...
            <div className="wireframesText">
              <p style={{ width: "500px" }}>
                Remedi was my final project while attending General Assembly's
                12 Week Web Development Immersive
              </p>
              <p style={{ width: "500px" }}>
                Remedi is a health wellness mobile application for both iOS and
                Android devices.
              </p>
              <p style={{ width: "500px" }}>
                Remedi was my first project built out in React Native! Super
                cool build and excited to get more familiar with it!
              </p>
            </div>
            <img
          ...
          <section className="RemediMiddle">
            <p className="soloText">
              The idea of Remedi is to first input your dietary restrictions.
              Then you can select your current meal time, select your level of
              hunger and then add what symptoms you are having. Remedi then will
              return what you should take to alleviate those symptoms!
            </p>
          </section>
