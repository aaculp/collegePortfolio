        ...
        <div className = 'RickContainer'>
          ...
          <section className = 'wireframesImg'>
            ...
            <div className = 'wireframesText'>
              ...
              <p style = {{marginTop: '20px'}}>It is currently only for desktop but soon to be a mobile app!</p>
              <p style = {{marginTop: '20px'}}>I am huge Rick & Morty fan so I decided to use this as the theme. Click the video below to play!</p>
            </div>
          </section>
